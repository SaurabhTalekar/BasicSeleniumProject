...
public class Using_PartialLinkText_Locator {
	...
	public static void main(String[] args) {
		...
		//Set up The browser       
		        ...
		        //Identify the element using the partialLinkText
		        WebElement linktext = driver.findElement(By.partialLinkText("Contact"));
